//
//  AirportWeatherNowCollectionViewCell.m
//  WeatherDemo
//
...
@implementation AirportWeatherNowCollectionViewCell
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        // Initialization code
        if (!_itemView) {
            _itemView = [[WeatherNowItemView alloc] initWithFrame:CGRectMake((self.contentView.frame.size.width - item_width)/2, top_margin + (self.contentView.frame.size.height - item_height - top_margin)/2, item_width, item_height)];
